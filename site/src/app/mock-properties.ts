...
export const PROPERTIES: Property[] = [

    {
        ...
        description: 'Home located in the sought after Wellswood section of Tampa, blocks from the Hillsborough River/Close to city it is being totally rehabed from floor to roof evertyhing brand new.',
