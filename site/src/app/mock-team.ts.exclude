...
export const TEAM: Teammember[] = [
    {
        ...
        quote: '',
        region: '',
        about: 'My entrepreneur spirit began early on and throughout the years I have owned different businesses including an alarm company and a Golden Corral restaurant.  Despite my background being in electronics, management, and construction, real estate remained my passion.  I began my real estate career in 2004 on a part-time basis and in 2007 I entered the real estate arena full-time.  Some of my past real estate ventures includes owning rental properties, property management, flipping a mobile home park, and renovating and building single family homes.  Currently I own and manage rental properties, wholesale and renovate single family homes as well as building new homes.  I have a wealth of information and experience which I passionately share with others.  I am personally rewarded when I spend time talking with home owners, buyers, and investors and am able to help them reach their goals.  I built my businesses around systems which allows me to work efficiently and maximize precious time.  I enjoy seeing properties and bare land transformed into a beautiful, high quality designed homes that buyers desire. It has been an exciting trip and yet the journey has just begun!'
    },
    //{
    //    name: 'M.J. Sklaruk',
    //    title: 'Management',
    ...
    //},
    {
        ...
        image: 'assets/images/team/russ.jpg',
        passions: '',
        moto: '',
        quote: '',
        region: '',
    ...
    }, 
    {
        ...
        image: 'assets/images/team/daveharo.jpg',
    ...
    },
    {
        ...
        image: 'assets/images/team/chelsea.jpg',
    ...
    }, 
    {
        ...
        moto: 'Be yourself, everyone else is taken.',
        ...
        region: 'Call North America home, with a special fondness for; New Jersey, Pittsburgh, Texas, and Florida. Prepared to bug out in Tennessee and live out the rest of days off grid.',
        about: 'A native born American, with long lived expertise in many aspects of computer science and artifical intellegence. Has lead the full life cycle development of systems that will be in use far after he expires. With computers, there is no favorite operating system, be it Windows, Linux or IOS the are all loved equally. A computer multlinguist including, binary, c, c++, vb, basic, sql, pl-sql, html, asp, jsp, java, javascript, xml, json, xslt, css, html5, fortran, cobal, pascal, tape basic, cpm, machine language, cold fusion, type script, AngularJS, Angular 2, Ember; the list really just goes on and on. Extreme database manipulator and general techno guru.'
    },
];
